async function draw() {
  ...
  const svg = d3.select('#chart')
    ...
    /**
     * Now instead of using fixed height and with attributes D3 provides an attribute called the viewbox which makes the chart responsive.
     * Viewbox has 4 values in which we want to keep the first 2 values on 0 
     */
